...
// Declared variables for high score section 
...
// starts timer and displays remaining seconds
...
// function to determine correct/wrong answers 
function compare(event) {
    ...
    if (element.matches("li")) {
        ...
        if (element.textContent == questions[questionIndex].answer) {
            ...
            // Will deduct 10 seconds of the remaining time if answered incorrectly
            secondsLeft = secondsLeft - penalty;
            createDiv.textContent = "Wrong! The correct answer is:  " + questions[questionIndex].answer;
        }

    }
    // Question Index shows number of question user is on
    questionIndex++;
